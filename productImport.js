...
setTimeout(function() {
    wait.launchFiber(function() {
        ...
        for (var i = 0; i < products.length; i++) {
            ...
            product.price = {};
            if (products[i].mrp_info[0] != undefined) {
                product.price.default_mrp = products[i].mrp_info[0].mrp;
                product.price.mrp = [];
                product.price.mrp.push({
                    "city": 4,
                    "mrp": product.price.default_mrp
                });
            } else {
                continue;
            }
            ...
            if (products[i].attributes.nutritional_information != undefined) {
                ...
                if (products[i].attributes.nutritional_information.total_fat != undefined) {
